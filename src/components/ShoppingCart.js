      ...
      <Register>
              {items.length>0?
                ...
                {items.map((item,index) => (
                    <ContainerProduct key={index}><Row><img src={item.img}></img> <strong> {item.name} </strong><h2></h2>{item.description}</Row><h3>R$ {item.price}</h3></ContainerProduct>
                ))}
                </Column>
                <ContainerProduct><strong>TOTAL</strong><strong>R$ {total}</strong></ContainerProduct></>
                :
                <>
                <ContainerProduct><strong>Esperando pedidos . . .</strong></ContainerProduct>
              </>}
      </Register>
      <Row>
